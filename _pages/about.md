...
<div style="display: flex; align-items: flex-start; gap: 18px; margin-bottom: 28px; clear: both;">
  <div style="flex: 0 0 200px;">
    <img src="/images/ubgold.png" style="width: 200px;">
  </div>
...
<div style="display: flex; align-items: flex-start; gap: 18px; margin-bottom: 28px; clear: both;">
  <div style="flex: 0 0 200px;">
    <img src="/images/arc.png" style="width: 200px;">
  </div>
